...
describe("Monthly Recurrence -> weekdayInMonth", () => {
	const currentInfo = MONTH_RECURRENCE_INFO.find((info) => info.recurrenceType === MonthYearRecurrenceType.weekdayInMonth) ?? MONTH_RECURRENCE_INFO[0];
	...
	describe("getProps", () => {
		it("should put the weekdayInMonth and weekday in the options", () => {
