...
describe("Monthly Recurrence -> dayBeforeEndOfMonth", () => {
	const currentInfo = MONTH_RECURRENCE_INFO.find((info) => info.recurrenceType === MonthYearRecurrenceType.dayBeforeEndOfMonth) ?? MONTH_RECURRENCE_INFO[0];
